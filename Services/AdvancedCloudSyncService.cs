...
namespace ComicReader.Services
{
    ...
    public event EventHandler<SyncProgressEventArgs>? SyncProgressChanged;
        ...
        public class SyncData
        {
            ...
            public List<ReadingProgress> ReadingHistory { get; set; } = new();
            public List<BookmarkData> Bookmarks { get; set; } = new();
            public List<ComicCollection> Collections { get; set; } = new();
        ...
        public class ReadingProgress
        {
            ...
            public string ComicHash { get; set; } = string.Empty;
        ...
        public class Annotation
        {
            ...
            public string ComicPath { get; set; } = string.Empty;
            public int PageNumber { get; set; }
            public string Type { get; set; } = string.Empty; // Note, Highlight, etc.
        ...
        public async Task<bool> LoginAsync(string username, string password)
        {
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    var tokenData = JsonSerializer.Deserialize<Dictionary<string, object?>>(responseData) ?? new();
                    _userToken = tokenData.TryGetValue("token", out var tv) ? Convert.ToString(tv) : null;
        ...
        private async Task<SyncData> DownloadRemoteDataAsync()
        {
            ...
            return JsonSerializer.Deserialize<SyncData>(json) ?? new SyncData();
        }
