...
namespace ComicReader.Views
{
    ...
    {
    private ReadingStats _stats = new ReadingStats();
    private ObservableCollection<ComicProgress> _recentProgress = new ObservableCollection<ComicProgress>();
    private ObservableCollection<ReadingSession> _todaySessions = new ObservableCollection<ReadingSession>();
...
namespace ComicReader.Models
{
    ...
    private string _favoriteGenre = string.Empty;
    private string _favoriteDay = string.Empty;
    private string _preferredFormat = string.Empty;
