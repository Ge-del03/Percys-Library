        ...
        public MainWindow()
        {
            ...
            _continuousView.ViewModel.CurrentPageChanged += (idx) =>
            {
                ...
                try
                {
                    ...
                    {
                        ComicReader.Services.ContinueReadingService.Instance.Remove(_comicLoader?.FilePath);
                    ...
                    if (_currentComicImage != null)
                    {
                        ...
                        try
                        {
                            ...
                            if (dir != 0)
                            {
                                ...
                                var readingDirRtl = SettingsManager.Settings?.ReadingDirection == "RightToLeft";
    ...
    private static readonly TimeSpan _interactionGrace = TimeSpan.FromSeconds(2);
        ...
        private void MainWindow_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            switch (e.Key)
            {
                ...
                case Key.A:
                case Key.K:
                    if (SettingsManager.Settings?.ReadingDirection == "RightToLeft") NextPage_Click(null, null); else PrevPage_Click(null, null);
                    e.Handled = true;
                    break;
                case Key.Right:
                case Key.PageDown:
                ...
                case Key.J:
                    ...
                    {
                        if (SettingsManager.Settings?.ReadingDirection == "RightToLeft") PrevPage_Click(null, null); else NextPage_Click(null, null);
                        e.Handled = true;
                    }
                    break;
                case Key.Home:
